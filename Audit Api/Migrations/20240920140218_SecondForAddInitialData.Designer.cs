...
namespace Audit_Api.Migrations
{
    ...
    [Migration("20240920140218_SecondForAddInitialData")]
    partial class SecondForAddInitialData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Audit_Api.Models.Audit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Action = "Create",
                            EmployeeID = 1,
                            Timestamp = new DateTime(2024, 9, 20, 18, 2, 8, 376, DateTimeKind.Local).AddTicks(6597),
                            UserID = 1
                        },
                        new
                        {
                            ...
                            Action = "Update",
                            EmployeeID = 2,
                            Timestamp = new DateTime(2024, 9, 20, 18, 2, 8, 376, DateTimeKind.Local).AddTicks(6611),
                            UserID = 2
                        },
                        new
                        {
                            ...
                            Action = "Delete",
                            EmployeeID = 3,
                            Timestamp = new DateTime(2024, 9, 20, 18, 2, 8, 376, DateTimeKind.Local).AddTicks(6613),
                            UserID = 3
                        });
                });
